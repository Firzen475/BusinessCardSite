...
<head>
    ...
    <link href="./css/logon/styles.css" rel="stylesheet">



    <script type="text/javascript" src="https://code.jquery.com/jquery-2.1.1.min.js"></script>
    <script src="js_php/jwt/submit.js"></script>
</head>

<body translate="no" onload="onLoadForm()">
<form id="logon" class="login-form" >
    <div class="flex-row">
        <label id="username_label" class="lf--label" for="username">
    ...
    <div class="flex-row">
        <label id="password_label" class="lf--label" for="password">
